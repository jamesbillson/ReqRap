     ...
     foreach($data as $line) { // LOOP THRU FLOWS
         ...
         <?php
                 if ($line['main']==1) { // THIS IS THE MAIN FLOW so show main heading
                       ...
                       <a href="<?php echo UrlHelper::getPrefixLink('/step/update/id/-1/flow/')?><?php echo $line['id'];?>"><i class="icon-edit" rel="tooltip" title="Edit Flow Steps"></i></a>
            ...
            <?php } ?> 
                       ...
                       <a href="<?php echo UrlHelper::getPrefixLink('/step/update/id/-1/flow/')?><?php echo $line['id'];?>"><i class="icon-edit" rel="tooltip" title="Edit Flow Steps"></i></a>
                        <a href="<?php echo UrlHelper::getPrefixLink('/flow/delete/id/')?><?php echo $line['id'];?>"><i class="icon-remove-sign" rel="tooltip" title="Delete Flow"></i></a>
          ...
          $steps= Step::model()->getFlowSteps($line['flow_id']); // get steps
                        ...
                        <tr>
                            ...
                            <a href="<?php echo UrlHelper::getPrefixLink('/step/update/flow/1/id/')?><?php echo $step['id'];?>"><i class="icon-edit" rel="tooltip" title="Edit"></i></a>
                            </td>
                            <td>
                            <?php
                        ...
                        <td colspan="2">
                        <?php if($edit){ ?>
                        <a href="<?php echo UrlHelper::getPrefixLink('/flow/create/start/')?><?php echo $step['step_id'];?>/id/<?php echo $model->usecase_id;?>"><i class="icon-code-fork icon-2x" rel="tooltip" title="Start Alternate Flow Here"></i></a>
                        <?php } ?> 
                        </td>    
                        </tr>
                        <?php
           ...
           <tr>
               <td colspan="5">
                   ...
                   <a href="<?php echo UrlHelper::getPrefixLink('/step/create/id/')?><?php echo $line['id'];?>"><i class="icon-plus-sign-alt" rel="tooltip" title="Add another step"></i></a> 
           <?php } ?> 
               </td>
           </tr>
