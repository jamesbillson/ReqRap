        ...
        foreach($usecases as $item) : ?>
          ...
          <tr class="odd">
              ...
              <td>
                  ...
                  <?php if($counter!=0) { ?>
                           <a href="<?php echo UrlHelper::getPrefixLink('/usecase/move/dir/2/id/')?><?php echo $item['id'];?>"><i class="icon-arrow-up" rel="tooltip" title="Move Up"></i></a> 
                  <?php } ELSE {?>   
                           
                           <i class="icon-flag" rel="tooltip" title="Start"></i>
                     <?php } ?>          
                   <?php if($counter!=count($usecases)-1) { ?>        
                           <a href="<?php echo UrlHelper::getPrefixLink('/usecase/move/dir/1/id/')?><?php echo $item['id'];?>"><i class="icon-arrow-down" rel="tooltip" title="Move Down"></i></a> 
         <?php } ?> 
              </td>
              <td> 
                   <a href="<?php echo UrlHelper::getPrefixLink('/usecase/view/id/')?><?php echo $item['id'];?>"> UC-<?php echo str_pad($model->number, 2, "0", STR_PAD_LEFT).''.str_pad($item['number'], 3, "0", STR_PAD_LEFT); ?></a>
               </td> 
              <td>
