...
class OrganisationtypeController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Organisationtype');
	...
	{
		$model=new Organisationtype('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Organisationtype']))
			$model->attributes=$_GET['Organisationtype'];
	...
	{
		$model=Organisationtype::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='organisationtype-form')
		{
