...
class TeststepController extends Controller
{
	...
	public function actionCreate($id, $step)
	{
		$model=$this->loadModel($step);
		    ...
		    $teststep=new Teststep;
                            ...
                            $this->redirect(array('/req/testcase/view/id/'.$id));
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Teststep']))
		{
			...
			if($model->save())
				$this->redirect(array('/req/testcase/view','id'=>$model->testcase_id));
		}
	...
	$model=$this->loadModel($id);
        ...
        $model->delete();
		    ...
		    $this->redirect(array('/req/testcase/view/id/'.$testcase_id));
                }
