...
class TestrunController extends Controller
{
	...
	{
		$model=new Testrun('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Testrun']))
			$model->attributes=$_GET['Testrun'];
	 ...
	 * @return Testrun the loaded model
	 ...
	 * @param Testrun $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='testrun-form')
		{
