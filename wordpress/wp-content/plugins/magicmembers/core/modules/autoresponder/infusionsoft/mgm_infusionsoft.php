...
class mgm_infusionsoft extends mgm_autoresponder{
	...
	function settings_update(){
		...
		switch($_POST['setting_form']){
			...
			// from box
				...
				$this->setting['post_url']	= $_POST['setting']['infusionsoft']['post_url'];
	...
	function set_postfields($user_id){
		// validate
		if(!isset($this->setting['api_key']) && !isset($this->setting['post_url'])){
			return false;
		}
		// userdata	
	...
	function validate(){
		...
		// check		
		if(empty($_POST['setting']['infusionsoft']['post_url'])){
