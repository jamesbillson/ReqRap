...
function mgm_filter_scripts() { 
	...
	//issue #1865
	if( mgm_is_plugin_active('wp-ultimate-csv-importer/index.php') || mgm_is_plugin_active('wp-ultimate-csv-importer-pro/index.php')){			
		$arr_wuci_exceptions =array('jquery.js');		
		$arr_exceptions = array_merge($arr_exceptions, $arr_wuci_exceptions);		
	}							
	//issue #1637
