...
/**
 * This is the model class for table "actorusecase".
 *
 * The followings are the available columns in table 'actorusecase':
 ...
 */
class Actorusecase extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('actor_id, usecase_id', 'required'),
	 ...
	 * @return Actorusecase the static model class
	 */
