...
class Changelog extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('project_id, object, action, data, modified_user, modified_date', 'required'),
			array('project_id, modified_user', 'numerical', 'integerOnly'=>true),
			array('object, action', 'length', 'max'=>60),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, project_id, object, action, data, modified_user, modified_date', 'safe', 'on'=>'search'),
		);
	}
